            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">List Penginapan</h3>
                        <div class="card-tools">
                            <a href="{{route('admin.penginapan.create')}}" class="btn btn-sm btn-primary">Tambah</a>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <table class="table table-bordered text-center text-wrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ asset('storage/penginapan/' . $item->image) }}" width="100px" height="100px" alt="{{ $item->name }}">
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route("admin.penginapan.delete",$item->id)}}" class="btn btn-danger">Hapus</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>

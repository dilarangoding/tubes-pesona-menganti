    ...
    <div class="container-fluid">
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                ...
                <li class="breadcrumb-item active">Tambah Pantai</li>
                </ol>
            </div>
        </div>
    </div>
...
<section class="content">
    <div class="container-fluid">
        <form action="{{route('admin.pantai.store')}}" method="post" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="number" name="ticket_price" class="form-control" value="{{ old('ticket_price') }}" >
